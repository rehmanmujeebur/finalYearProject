...
# Define the Random Forest model with fewer estimators.
random_forest = RandomForestClassifier(n_estimators=50)  # You can adjust the number of trees (n_estimators) as needed

# Reshape the image data for Random Forest.
...
y_pred_rf = random_forest.predict(X_test_reshaped)
